...
{
    public partial class newMyMissionaryMail : Migration
    {
        public override void Up(MigrationBuilder migration)
        {
            ...
            migration.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentCount = table.Column(type: "int", nullable: true),
                    BodyHtml = table.Column(type: "nvarchar(max)", nullable: true),
                    BodyPlain = table.Column(type: "nvarchar(max)", nullable: true),
                    FromEmail = table.Column(type: "nvarchar(max)", nullable: true),
                    RecipientEmail = table.Column(type: "nvarchar(max)", nullable: true),
                    StrippedHtml = table.Column(type: "nvarchar(max)", nullable: true),
                    StrippedSignature = table.Column(type: "nvarchar(max)", nullable: true),
                    StrippedText = table.Column(type: "nvarchar(max)", nullable: true),
                    Subject = table.Column(type: "nvarchar(max)", nullable: true),
                    TimeStamp = table.Column(type: "datetime2", nullable: false),
                    TimeStampSeconds = table.Column(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
